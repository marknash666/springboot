...
public class LAGCreditController {
    ...
    @RequestMapping(value="/getCurrentSupply",method= RequestMethod.GET, produces = "application/json;charset=UTF-8")
    ...
    public String transfer_web(@RequestBody TransferParam param){
        ...
        if(state)
        {
            String response1= ("The supply in the sender's account is " + getBalanceOfCurrentUser(creditAddress));
            String response2 = ("The supply in the receiver's account is " + getBalanceByOwner(creditAddress,to));
